        ...
        <div className='hidden bg-gradient-to-b from-[#FFFFFF] to-[#F0F1FF] z-0'>
            <div className='mx-[20px] md:mx-[40px] lg:mx-[160px] pb-[140px]  pt-[130px] grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-20'>
                ...
                <div className='relative md:h-[259px] lg:h-[322px] rounded-2xl bg-gradient-to-t from-[#F02AA6] to-[#FF6F48] pl-8 pr-16 pt-16'>
                    <h1 className='text-white md:text-[24px] lg:text-[34px] font-[600] md:leading-[32px] lg:leading-[40px]'>
                        Check out our most popular courses!
                    </h1>
                </div>

                {/* Box 2 */}
                <div className='relative md:h-[259px] lg:h-[322px] rounded-2xl bg-white md:pl-8 md:pr-6 lg:px-8 pt-16 pb-10'>
                    {/* Icon */}
                    ...
                    <div className='flex flex-col h-[100%] justify-between gap-4'>
                        <h2 className='text-fmDarkBlue md:text-[20px] lg:text-[24px] font-[700]'>
                            Animation
                        </h2>
                ...
                {/* Box 5 */}
                <div className='relative md:h-[259px] lg:h-[322px] rounded-2xl bg-white md:pl-8 md:pr-5 lg:px-8 pt-16 pb-10'>
                    {/* Icon */}
                    <div>
